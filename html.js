...
<html lang="en" with-selection-styled>
  <head>
    ...
    <title>Web Scraper - Cloudflare Workers®</title>
    ...
    <meta property="og:url" content="https://web.mrgabonijeff.workers.dev/">

    <meta name="twitter:site" content="@iamthenewking">
    <meta name="twitter:creator" content="@iamthenewking">
    ...
    <meta name="twitter:url" content="https://web.mrgabonijeff.workers.dev/">
    ...
    <div class="Surface">
      <div class="Panel">
        ...
        <main class="Panel--main" is-smooth-scrolling>
          <form id="form" class="Stack" method="GET" action="https://web.mrgabonijeff.workers.dev">
            <div class="FormField">
